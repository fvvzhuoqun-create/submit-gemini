<template>
  <el-header class="fater-header">
    ...
    <el-dropdown @command="handleUser" class="fater-header-user" trigger="click">
			<span class="el-dropdown-link" style="display:flex; align-items:center;">
                <el-avatar size="small" icon="el-icon-user-solid" style="background:#009999; margin-right:8px;"></el-avatar>
				个人中心
                <i class="el-icon-arrow-down el-icon--right"></i>
			</span>
      <el-dropdown-menu slot="dropdown">
        <el-dropdown-item command="info" icon="el-icon-user">个人信息</el-dropdown-item>
        <el-dropdown-item command="pwd" icon="el-icon-key">修改密码</el-dropdown-item>
        <el-dropdown-item command="exit" divided icon="el-icon-switch-button">退出系统</el-dropdown-item>
      </el-dropdown-menu>
    </el-dropdown>
