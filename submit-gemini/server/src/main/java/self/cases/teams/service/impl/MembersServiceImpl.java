...
public class MembersServiceImpl implements MembersService {
    ...
    @Override
    @Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
    public PageData getPageByMemId(Long pageIndex, Long pageSize, String memId, String teamName, String userName) {

        Page<Map<String, Object>> page =
                membersDao.qryPageByMemId(new Page<Map<String, Object>>(pageIndex, pageSize), memId, teamName, userName);
