  ...
  public static void main(String args [])
  {
    try
    {
     ...
     // System.out.println("词法分析:\n");
      System.out.println("\u8bcd\u6cd5\u5206\u6790:\u005cn");//词法分析�?
      String st = new String("\u8bcd\u6cd5\u5206\u6790:\u005cn");//词法分析�?
     ...
     fos1.write(buffer); // 写入文件
      ...
      // 语义分析
      System.out.println("\u8bed\u4e49\u5206\u6790: \u005cn");//语义分析
      st = new String("\u8bed\u4e49\u5206\u6790: \u005cn");
      buffer = st.toCharArray();
      fos2.write(buffer); // 写入文件
...
// 变量重复声明
 ...
 //    QTInfo qtInfo = new QTInfo("j", e1, e2, "T");
  //  qtList.addQTInfo(qtInfo);
   // cValue.mergeTrue(qtInfo);
